...
class Passport extends Component {
    ...
    render() {
        ...
        return (
            <Animated.View>
            <AnimatedCard  height={cardHeight} margin={margin} bgColor="#b71c1c">
            {
            ...
            onPress={()=>this.expandCard()}>{isOpen ? <Icon name="close" size={25} color="#fff"/> : <InfoText>Add</InfoText>}{/*<Icon name={isOpen ? "expand-less" : "expand-more"} size={25} color="#fff"/>*/}
