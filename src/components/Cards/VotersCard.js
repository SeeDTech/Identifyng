...
class VotersCard extends Component {
    ...
    render() {
        ...
        return (
            ...
            <Thumbnail style={{ marginLeft: "auto", marginTop: 5}} square resizeMode="contain"  source={require('../../assests/img/inec.png')}/>
            </Row>
            <AnimatedView style={{ opacity:itemOpacityb, height:"auto", }}>
            <Row style={{...CardStyle.rowb}}>
            <InfoText isKey>{"You don't have your Voter's Card registered on IDentifyng"}</InfoText>
            </Row>
            {
            ...
            onPress={()=>{this.props.setActiveCard(0); this.props.setWebUrl(4)}}>{isOpen ? <Icon name="close" size={25} color="#fff"/> : <Icon name="add" size={25} color="#fff"/>}{/*<Icon name={isOpen ? "expand-less" : "expand-more"} size={25} color="#fff"/>*/}
