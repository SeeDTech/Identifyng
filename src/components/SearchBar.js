...
export class SearchBar extends Component {
    ...
    render() {
        ...
        const reduceWidth = this.animatedValue.interpolate({
            inputRange: [0, 1],
            outputRange: [150,50]
        })
        return (
            <Animated.View  style={{width:increaseWidth,marginRight: 15,}}>
                ...
                <TextInput onBlur={handle} onFocus={()=>this.animate()} onChangeText={(newText) => this.setState({ searchKey: newText })}  style={{ borderWidth: 2, width: '100%', height: 30, borderRadius: 30, borderColor: '#f4f4f4', backgroundColor: '#e0e0e0', color: BaseColor.grey,  padding: 0, paddingHorizontal: 30, marginVertical: 0, fontSize: 11, fontFamily: "Ubuntu-Regular" }} >
                </TextInput>
            </Animated.View>
        )
    }
